...
libraryDependencies ++= Seq(
  ...
  "org.apache.spark" %% "spark-mllib" % "1.1.0",            // Apache v2
  "org.apache.spark" %% "spark-graphx" % "1.1.0",           // Apache v2
...
//
libraryDependencies ++= Seq(
  "org.jfree" % "jfreechart" % "1.0.19", //TODO How to handle since this is LGPL
